...
namespace {
  ...
  static Sys::int16 p[] = { 151,160,137,91,90,15,
  ...
  static Sys::int16 perm[512];
  static Sys::int16 permMod12[512];
  ...
  inline
  double dot(const Grad& g, double x, double y) {
    return g.x*x + g.y*y; }

  inline
  double dot(const Grad& g, double x, double y, double z) {
    return g.x*x + g.y*y + g.z*z; }

  inline
  double dot(const Grad& g, double x, double y, double z, double w) {
...
// 2D simplex noise
///////////////////////////////////////////////////////////////////
double snoise2(double xin, double yin)
{
...
// 3D simplex noise
///////////////////////////////////////////////////////////////////
double snoise3(double xin, double yin, double zin)
{
